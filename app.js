...
/**
 * NEW: The Secure API Caller
 * This talks to your Vercel Middleman so keys don't leak, gang.
 */
async function generateAIResponse(messages, modelMode = 'Auto') {
  try {
    ...
    // Fallback to internal/mock if the Vercel function is cooked 💔
    return "Aura's brain is fuzzy right now. Check your Vercel keys? (Error: " + error.message + ")";
  }
}
    ...
    return (
      <div data-name="app" data-file="app.js">
        <ChatInterface 
          ...
          // PASS THE NEW SECURE FUNCTION HERE
